...
public class Kunde extends Person {
    ...
    public Kunde(Integer id, String name, String nachname, Integer telefonnummer,  Double kontostand, int kundeid,double rabatt,int gekauftereiepakete, int kontostand) {
