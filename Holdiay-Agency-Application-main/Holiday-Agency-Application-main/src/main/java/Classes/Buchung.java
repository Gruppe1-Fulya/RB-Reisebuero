...
public class Buchung {
    ...
    public Termin(String kundename, String kundenachname) throws SQLException {
        buchungid = FullDB.getBuchungId();
        this.kundename = kundename;
        this.kundenachname = kundenachname;
    }
